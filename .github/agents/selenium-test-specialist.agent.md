---
description: 'Specialize in creating Selenium WebDriver tests following best practices, POM pattern, and project conventions for the Music Tech Shop e-commerce application.'
name: 'Selenium Test Specialist'
tools: ['read', 'edit', 'search', 'execute', 'glob', 'grep', 'web']
---
